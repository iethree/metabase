...
describe("version-helpers", () => {
  describe("normalizeVersionNumber", () => {
    it("should always be in the format v0.1.2.3", () => {
      const cases = [
        ["21.2.3", "v0.21.2.3"],
        ["x.1.2.3", "v0.1.2.3"],
        ["21", "v0.21"],
      ...
      cases.forEach(([input, expected]) => {
        expect(normalizeVersionNumber(input)).toEqual(expected);
      });
    });

    it("should output OSS version by default", () => {
      expect(normalizeVersionNumber("21.2.3")).toEqual("v0.21.2.3");
    });

    it("should output EE version with a flag", () => {
      const cases = [
        ["21.2.3", "v1.21.2.3"],
        ["x.1.2.3", "v1.1.2.3"],
        ["21", "v1.21"],
      ...
      cases.forEach(([input, expected]) => {
        expect(normalizeVersionNumber(input, true)).toEqual(expected);
      });
    });
  });
  ...
  describe("isLatestVersion", () => {
    ...
    it(`should return false for non-latest releases`, () => {
      const cases: [string, string[]][] = [
        ["v0.21.2.1", ["v0.24", "v0.25.1", "v0.25.2"]],
        ["v0.25.1.2", ["v0.24", "v0.25.1", "v0.25.2"]],
        ["v0.25", ["v0.24", "v0.25.1", "v0.25.2"]],
        ["v0.25.1.99", ["v0.24", "v0.25.1", "v0.25.2"]],
      ];
      cases.forEach(([input, releases]) => {
    ...
    it("should never mark an RC as latest", () => {
      const cases: [string, string[]][] = [
        ...
        ["v0.99-rc99", ["v0.24", "v0.25.1", "v0.99-rc4"]],
      ];
